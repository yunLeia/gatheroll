  ...
  return (
    <main>
      ...
      <section className="hero">
        ...
        <ApiHealth />
        <p><Link className="primary-link" href="/events/new">Create an event →</Link></p>
      </section>

      <section className="flow" aria-labelledby="flow-heading">
        <h2 id="flow-heading">The hypothesis</h2>
        <ol>
          <li><span>01</span>Create an event</li>
          <li><span>02</span>Friends scan and join</li>
          <li><span>03</span>Select broadly, review privately</li>
          <li><span>04</span>Enjoy one shared album</li>
        </ol>
      </section>
    </main>
  );
